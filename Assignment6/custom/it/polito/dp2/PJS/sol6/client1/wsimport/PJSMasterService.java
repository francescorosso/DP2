 ...
 * 
 */
@WebServiceClient(name = "PJSMasterService", targetNamespace = "http://service.sol6.PJS.dp2.polito.it/", wsdlLocation = "http://localhost:8182/PJSMaster?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8182/PJSMaster?wsdl");
